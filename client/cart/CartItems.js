      ...
      {this.state.cartItems.length>0 ? (<span>
              ...
              <div className={classes.details}>
                ...
                <div className={classes.subheading}>
                  Cantidad: <TextField
                              ...
                              margin="normal"/>
                            <Button className={classes.removeButton} color="primary" onClick={this.removeItem(i)}>x Remover</Button>
                </div>
              </div>
            </Card>
            <Divider/>
        ...
        <div className={classes.checkout}>
          ...
          {!this.props.checkout && (auth.isAuthenticated()?
            <Button color="secondary" variant="raised" onClick={this.openCheckout}>Ordenar</Button>
            :
            <Link to="/signin">
              <Button color="primary" variant="raised">Ingresa para Ordenar</Button>
            </Link>)}
